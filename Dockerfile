...
RUN echo "create keyspace joey with replication = {'class':'SimpleStrategy', 'replication_factor': 3};" > /home/scripts/create-cassandra-table.cql && \
    ...
    echo "list(rows)" >> /home/scripts/test-cassandra-table.py
...
# 3. Build container and map a local drive to the /home/host folder inside the container
# docker run --name hadoop-client -p 50070:50070 -p 8088:8088 -p 10020:10020 -v "/Users/joey/Dev/:/home/host" -it joegagliardo/hadoop /etc/bootstrap.sh -bash
...
# docker run --name hadoop-client -p 50070:50070 -p 8088:8088 -p 10020:10020 -v "/Users/joey/Dev/:/home/host" -it $IMAGEID /etc/bootstrap.sh -bash
